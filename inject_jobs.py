...
METRIC_FIELDS = ("contacted", "screens", "actual_screens", "ats", "int1", "int2", "int3", "offered", "hired")
...
def aggregate_jobs(rows, name, role, iso_week, pd_client=None, iso_year=2026):
    ...
    for r in rows:
        ...
        b = bucket.setdefault(job_id, {
            ...
            "contacted": 0, "screens": 0, "actual_screens": 0, "ats": 0,
            "int1": 0, "int2": 0, "int3": 0, "offered": 0, "hired": 0,
        })
